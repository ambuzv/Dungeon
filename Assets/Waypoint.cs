...
public class Waypoint : MonoBehaviour
{
	...
	void Update()
	{
		bool occupied 	= camera1.transform.parent.transform.position == gameObject.transform.position;
	...
	public void Click()
	{
		...
		camera1.transform.parent.transform.position = gameObject.transform.position;
	}
